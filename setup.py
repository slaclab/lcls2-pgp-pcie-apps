...
setup(
    ...
    packages = [
        ...
        'lcls2_pgp_pcie_apps.surf.devices.maxim',
        ...
        'lcls2_pgp_pcie_apps.surf.protocols.coaxpress',
        'lcls2_pgp_pcie_apps.surf.protocols.htsp',
        ...
        'lcls2_pgp_pcie_apps.surf.protocols.sugoi',
    ],
    package_dir = {
